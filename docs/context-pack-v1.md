> 🟡 **ARCHIVED** (لقطة مبكّرة، ما قبل الترحيل إلى Fly.io — لا تُحدَّث). للحالة الحيّة الآن انظر `STATE.md` في الجذر. النسخة الأحدث المؤرشفة: `docs/context-pack-v3.md`.
...
| **الجهة الراعية** | مركز تفسير للدراسات القرآنية (Tafsir Center for Quranic Studies, https://tafsir.net) |
